 ...
 */
class PkmnListPagingSource(private val query: String?, private val refresh: Boolean = false, private val getListPage: GetPkmnListPage) : PagingSource<Int, PkmnEntity>() {
