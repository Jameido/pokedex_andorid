...
class PkmnDetailUnitTest {
    ...
    fun parsePkmnDetail() {
        try {
            val detailResponse = moshi.adapter(PkmnDetail::class.java).fromJson(DETAIL_DITTO)
            ...
            Assert.assertNotNull(detailResponse!!.types[0].type)
            Assert.assertEquals(detailResponse!!.types[0].type.name, "normal")
